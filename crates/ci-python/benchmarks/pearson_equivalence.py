...
print("Empty Z test 1 pgmpy: p_value: ", p_value, ", statistic: ", statistic)
print(f"Empty Z test 1 Rust: {test(array_empty, x_ind, y_ind)}")
...
statistic, p_value = pe.run_test('X', 'Y', [])
print("Empty Z test 2 pgmpy: p_value: ", p_value, ", statistic: ", statistic)
print(f"Empty Z test 2 Rust: {test(array_empty, x2, y2)}")